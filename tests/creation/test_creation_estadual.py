...
@pytest.fixture()
def portal(portal_estadual):
    """Site é criado pelo arquivo testing.py"""
    setSite(portal_estadual)
    return portal_estadual


class TestPortalLegEstadual:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ["deputado", "Deputado(a)"],
            ["presidente", "Presidente da Assembléia"],
        ],
    )
